      ...
      const response = await fetch(OPENAI_API_URL, {
        ...
        body: JSON.stringify({
          ...
          messages: [
            {
              role: 'system',
              content: `You are the AI assistant for BISMI Aari & Mehendi Center (website: bismiaarimehendi.store). Your role is to interact with customers naturally, helpfully, and in a friendly, conversational style. Follow all these rules:
...
2. **Business Knowledge**:
   - Henna Cones:
    - Ask the owner to confirm current price and delivery availability.
   - Aari Embroidery / RE Works:
     - Price depends on the design and work required; do not invent a range.
   - Instagram gallery, WhatsApp contact, and website details should be referenced accurately from bismiaarimehendi.store.
...
5. **Additional Notes**:
  ...
  function generateBotResponse(userMessage) {
    ...
    if (message.includes('price') || message.includes('cost') || message.includes('rate') || message.includes('velai')) {
      return "Sure ma! Aari pricing depends on the design and work required, so please send your reference image for an exact quotation. For cone pricing, pack options and availability, WhatsApp BISMI directly ma.";
    }
    
    if (message.includes('henna') || message.includes('cone') || message.includes('mehendi')) {
      return "Oh ma, please WhatsApp BISMI for current Mehendi cone pack options, pricing and delivery details. Product and skin-safety details should be confirmed before ordering ma. <a href='https://wa.me/919677179922?text=Hi%20ma!%20I%20want%20to%20ask%20about%20Mehendi%20cone%20availability%20and%20pack%20options.' target='_blank' rel='noopener noreferrer' style='color: #25D366; text-decoration: none; font-weight: bold;'>Ask About Cones</a>";
    }
    ...
    if (message.includes('aari') || message.includes('embroidery') || message.includes('blouse') || message.includes('saree') || message.includes('pattu')) {
      return "Aari work is our specialty ma! Each piece is discussed around the design, garment and work required. Send your reference image and event date for an exact quotation ma. <a href='https://wa.me/919677179922?text=Hi%20ma!%20I%20want%20to%20discuss%20Aari%20embroidery%20work%20with%20BISMI.%20Please%20help%20me%20with%20design%20and%20pricing.' target='_blank' rel='noopener noreferrer' style='color: #25D366; text-decoration: none; font-weight: bold;'>✨ Discuss Aari Work</a>";
    }
    ...
    if (message.includes('organic') || message.includes('natural') || message.includes('stain') || message.includes('chemical') || message.includes('pure')) {
      return "For product or skin-safety questions ma, please ask BISMI directly before ordering. We do not make a safety or stain guarantee without confirmed product information. <a href='https://wa.me/919677179922' target='_blank' rel='noopener noreferrer' style='color: #25D366; text-decoration: none; font-weight: bold;'>Ask BISMI</a>";
    }
    ...
    if (message.includes('time') || message.includes('duration') || message.includes('how long') || message.includes('neram') || message.includes('evlo')) {
      return "Good question ma! Aari timing depends on the design and current availability. Please send your event date and reference image so BISMI can discuss it with you ma.";
    }
    
    if (message.includes('location') || message.includes('address') || message.includes('where') || message.includes('enga') || message.includes('area')) {
      return "We're in Pandaravadai, Thanjavur ma! Please WhatsApp BISMI to confirm current delivery or pickup arrangements for your specific requirement.";
    }
    ...
    if (message.includes('delivery') || message.includes('deliver') || message.includes('parcel') || message.includes('send') || message.includes('ship') || message.includes('abroad') || message.includes('international')) {
      return "Delivery arrangements depend on the product, garment and location. Please WhatsApp BISMI with your location so the current options can be confirmed ma.";
    }
    ...
    if (message.includes('payment') || message.includes('upi') || message.includes('gpay') || message.includes('phonepe') || message.includes('paytm') || message.includes('advance')) {
      return "Payment and booking details should be confirmed directly with BISMI for your order ma. WhatsApp your requirement and reference image to begin.";
    }
